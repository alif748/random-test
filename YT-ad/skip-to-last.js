...
(function() {
        ...
        setInterval(() => {
            ...
            if (ad) {
                ...
                if (video){
                    ...
                    // Skip to the last 3 seconds of the video
                    let adDuration = video.duration;
                    if (adDuration) {
                        video.currentTime = adDuration - 5;
                    }
                }
    ...
    function checkForUpdate(){
        ...
        .then(data => {
            ...
            if (!match) {
                log("Unable to extract version from the GitHub script.");
                return;
            }
